...
## S3 进度
- [x] brainstorm: TMC5160 软件闭环方案
- [x] milestones: 4 个子步骤 (S3-A / S3-B / S3-C / S3-D)
- [x] S3-A: PID 控制器模块 ✅
- [x] S3-B: 闭环控制模块 ✅
- [x] S3-C: 闭环模式切换 ✅
- [x] S3-D: 集成测试 ✅
...
- [x] 闭环控制: ✅ 空载偏差 < 13 微步 (2026-07-24)
- [x] CAN 反馈: ✅ 改为 X_ENC 编码器实测值 (2026-07-24)
- [x] 上电可靠性: ✅ 增加 50ms 上电延时 + SPI 通信验证 (2026-07-24)
- [x] 编码器归零: ✅ 上电自动消除编码器初始偏移 (2026-07-24)
- [ ] 电机1 (芯片1): ⏭️ 硬件未焊接，待补测
