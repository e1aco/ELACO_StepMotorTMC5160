# TMC5160A_Datasheet_Rev1.14 — 第11章 11 Diagnostics and Protection

--- [PAGE 78] ---
TMC5160/TMC5160A DATASHEET (Rev. 1.14 / 2020-MAY-19)  78 
 
 
 
www.trinamic.com 
11 Diagnostics and Protection 
The TMC 5160 supplies a complete set of diagnostic and protection capabilities, like short circuit 
...
adjacent components  against excess h eat. Choose the overtem perature level to safely cover error 
conditions like missing heat convection. Heat is mainly generated by the power MOSFETs , and, at 
increased voltage, by the internal  voltage regulator s. For many applications, already the 
...
just an emergency measure and temperature rising to the shutdown leve l should b e prevented by 
design.  
...
The TMC 5160 protects the MOSFET power stages against a short circuit or overload condition by 
...
allows filtering of the sig nal. This helps to prevent spurious triggering caused by effects of P CB 
...
2 (2µs), 
3 (3µs) 
shortdelay shortdelay: Short detection delay  
...
CHOPCONF. 
diss2vs 
Allows to disable short to VS protection. 0/1 Leave detection enabled 
for normal use (0). 
CHOPCONF. 
diss2g 
Allows to disable short to GND protection. 0/1 Leave detection enabled 
for normal use (0). 
 
--- [PAGE 79] ---
TMC5160/TMC5160A DATASHEET (Rev. 1.14 / 2020-MAY-19)  79 
...
VS
tSD
detection activeShort to GND monitor phase
Internal Error Flag
tSD
Short detectedshort 
delay
...
S2VS level
VBM
Short to VS monitor phase short 
delayinactive detection 
active inactive
inactive
tSD
Internal low-side 
...
provides good precision of current detection. This way, it will safely c over most overcurrent 
...
short event is rather undefined and a complex network of  external compone nts may be involved. 
...
Attention 
High-side short detection (S2G) sensitivity may increase at voltage s of 52V and above. Therefore, a 
...
--- [PAGE 80] ---
TMC5160/TMC5160A DATASHEET (Rev. 1.14 / 2020-MAY-19)  80 
...
current. This way, also undervoltage conditions, high motor velocity s ettings or short and 
overtemperature conditions may cause triggering of the open load flag, and inform the user, that 
motor torque may suffer. In motor stan d still, open load cannot be measured, as the coils might 
