...
TMC5160/TMC5160A DATASHEET (Rev. 1.14 / 2020-MAY-19)  101 
...
& 
vhighchm 
These chopper conf iguration flags in CHOPCONF 
need to be set for DcStep operation. As soon as 
VDCMIN becomes exceeded, the chopper becomes 
switched to fullstepping. 
0 / 1 set to 1 for DcStep 
TOFF DcStep often benefits from an increased off time 
value in CHOPCONF. Settings >2 should be 
preferred. 
2… 15 Settings 8…15 do not make 
any difference to setting 8 
for DcStep operation. 
VDCMIN This is the lower threshold for DcStep operation 
...
DC_TIME This setting controls the reference pulse width for 
...
DC_SG This setting controls stall detection in DcStep 
mode. Increase for higher sensitivity. 
 
A stall ca n be used as an error condition by 
...
0… 255 Set slightly higher than 
DC_TIME / 16 
