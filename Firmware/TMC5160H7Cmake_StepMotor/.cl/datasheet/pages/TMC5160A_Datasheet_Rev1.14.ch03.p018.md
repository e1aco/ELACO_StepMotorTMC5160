...
TMC5160/TMC5160A DATASHEET (Rev. 1.14 / 2020-MAY-19)  18 
...
Ensure ~30% headroom 
Reset Default: 0 
BBMCLKS Like BBMTIME, but in multiple of a clock cycle. 
...
increasing the value of the gate series resistors. A slope time of nominal 4 0ns to 80ns is absolutely 
...
switching event, gives best results. Add roughly 30% of reserve, to cov er production stray of MOSFETs 
and driver. 
