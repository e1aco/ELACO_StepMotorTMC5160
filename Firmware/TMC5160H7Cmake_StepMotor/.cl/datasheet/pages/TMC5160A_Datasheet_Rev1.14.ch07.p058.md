...
TMC5160/TMC5160A DATASHEET (Rev. 1.14 / 2020-MAY-19)  58 
...
process and check opti mum tuning conditions using the evaluation board. It i s recommended to use 
...
Successful completion o f AT#1 tuning phase is not safely detected by the TMC5160. It will require 
...
standstill detection in betwee n of each two steps. Use a velocity of 8 (6 Hz) or lower and execute 
...
operating conditions determined for the appl ication and do a complete automatic tuning sequence 
