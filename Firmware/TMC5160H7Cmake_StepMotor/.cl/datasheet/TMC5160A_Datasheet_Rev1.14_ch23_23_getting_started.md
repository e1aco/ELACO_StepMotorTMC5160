# TMC5160A_Datasheet_Rev1.14 — 第23章 23 Getting Started

--- [PAGE 116] ---
TMC5160/TMC5160A DATASHEET (Rev. 1.14 / 2020-MAY-19)  116 
 
 
 
www.trinamic.com 
23 Getting Started 
Please refer to the TMC 5160 evaluation board to allow a quick start with the device, and in order to 
...
SPI sample sequence to enable and initializ e the motion controller  and move one rotation (51200 
