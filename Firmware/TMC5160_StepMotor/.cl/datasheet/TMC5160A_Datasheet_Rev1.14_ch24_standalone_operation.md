# TMC5160A_Datasheet_Rev1.14 — 第24章 STANDALONE OPERATION
...
| tional use lower tage down to 12V VM 12 02 0n V 1 10 60 Vn 100n STEP DIR CPO CPI VCP VS VSA CB2 12VOUT 11.5V Voltage Step&Dir input charge pump HS HB2 CB |  |  |  |  |  |  |
|---|---|---|---|---|---|---|
|  |  |  | 100n CB2 HS HB2 CB |  |  |  |
|  | 2.2µ 5VOUT 2.2µ 2R2 VCC | regulator with microPlyer 5V Voltage regulator HS TMC5160 LS LS Configuration interface (GND lo evr eV l)CC_IO Controller Chopper B.Dwersteg, © TRINAMIC 2014 TB R. ID Nw Ae Mrs ICte g 2, 0 © 14 HS HS Status out (open drain) LS LS mode selection | HS LS LS | CB1 CB HB1 BMB1RG |  |  |
| 470n CFG0 CFG1 CFG2 CFG3 CFG4 CFG5 CFG6 DIAG1 DIAG0 k CLK_IN z IO VCCIO |  |  |  |  |  |  |
|  |  |  |  | LA1 |  |  |
|  |  |  |  | RG LA2 |  | RG |
|  |  |  |  | SRAH 47R SRAL |  |  |
...
| GND |  |  | VCC IO _ | 16 microsteps, MRES=4 |  |
| VCC IO _ |  |  | GND | 32 microsteps, MRES=3 |  |
| VCC IO |  |  | VCC IO | 64 microsteps, MRES=2 |  |
--- [PAGE 118] ---
TMC5160/TMC5160A DATASHEET (Rev. 1.14 / 2020-MAY-19)  
118 
...
| GND |  |  | VCC IO |  |  | GND |  |  | IRUN=20 |  |  |
| GND |  |  | _ VCC IO _ |  |  | VCC IO _ |  |  | IRUN=22 |  |  |
| VCC IO _ |  |  | GND |  |  | GND |  |  | IRUN=24 |  |  |
| VCC IO |  |  | GND |  |  | VCC IO |  |  | IRUN=26 |  |  |
| _ VCC IO _ |  |  | VCC IO _ |  |  | _ GND |  |  | IRUN=28 |  |  |
...
| VCC IO _ |  |  | StealthChop operation. (GCONF.en PWM mode=1) _ _ |  |  |

|  | CFG6: CONFIGURATION OF HOLD CURRENT REDUCTION |  |  |  |  |
|---|---|---|---|---|---|
|  | CFG6*) |  |  | Chopper Setting |  |
| GND |  |  | No hold current reduction. IHOLD=IRUN |  |  |
| VCC IO _ |  |  | Reduction to 50%. IHOLD=1/2 IRUN |  |  |
