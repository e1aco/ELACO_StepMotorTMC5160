# TMC5160A_Datasheet_Rev1.14 — 第14章 COOLSTEP OPERATION
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| SEMIN | SEMIN |  | 4-bit unsigned integer that sets a lower threshold. If SG goes below this threshold, CoolStep increases the current to both coils. The 4-bit SEMIN value is scaled by 32 to cover the lower half of the range of the 10-bit SG value. (The name of this parameter is derived from smartEnergy, which is an earlier name for CoolStep.) |  |  | 0 |  |  | disable CoolStep |  |  |
...
stop on stall. Above this velocity CoolStep 
...
| curre motor motor current reduction area curre (upp ½ or motor current increment area (low stall possible Zeit to load due load due increased reduction motor load increment angle load angle optimized load angle optimized optimized reduced current rrent to |  |  |  |  |  |
|---|---|---|---|---|---|
|  | motor current reduction area |  |  |  |  |
|  |  |  |  |  |  |
|  |  |  |  |  |  |
...
|  |  |  | motor current i |  |  |
|  |  |  |  | ncrement area |  |
| load angle optimized |  |  | stall po | ssible |  |
|  |  | rrent increment due to increased load | load angle optimized | current reduction due to reduced motor load |  |

|  | Parameter |  |  | Description |  |  | Range |  |  | Comment |  |
|---|---|---|---|---|---|---|---|---|---|---|---|
| SEUP | SEUP |  | Sets the current increment step. The current becomes incremented for each measured StallGuard2 value below the lower threshold. |  |  | 0…3 |  |  | step width is 1, 2, 4, 8 |  |  |
...
| SEIMIN |  |  | Sets the lower motor current limit for CoolStep operation by scaling the IRUN current setting. |  |  | 0 |  |  | 0: 1/2 of IRUN |  |  |
|  |  |  |  |  |  | 1 |  |  | 1: 1/4 of IRUN |  |  |
...
|  | word |  |  |  |  |  |  |  |  |  |  |
| CSACTUAL | CSACTUAL |  | This status value provides the actual motor current scale as controlled by CoolStep. The value goes up to the IRUN value and down to the portion of IRUN as specified by SEIMIN. |  |  | 0…31 |  |  | 1/32, 2/32, … 32/32 |  |  |
--- [PAGE 93] ---
TMC5160/TMC5160A DATASHEET (Rev. 1.14 / 2020-MAY-19)  
93 
