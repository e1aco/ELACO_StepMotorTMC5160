# TMC5160A_Datasheet_Rev1.14 — 第6章 · p52
...
| 11 | 11 |  | fd3 |  |  | TFD [3] |  |  | chm=1: MSB of fast decay time setting TFD |  |  |  |
...
| 5 |  |  | hstrt1 |  |  |  |  |  |  |  |  |  |
| 4 |  |  | hstrt0 |  |  |  |  |  |  |  |  |  |
|  |  |  |  |  |  | TFD [2..0] fast decay time setting |  |  | chm=1 |  | Fast decay time setting (MSB: fd3): %0000 … %1111: Fast decay time setting TFD with N = 32*TFD (%0000: slow decay only) CLK |  |
|  | 3 |  | toff3 |  |  | TOFF off time and driver enable |  |  | Off time setting controls duration of slow decay phase N = 24 + 32*TOFF CLK %0000: Driver disable, all bridges off %0001: 1 – use only with TBL ≥ 2 %0010 … %1111: 2 … 15 |  |  |  |
|  | 2 |  | toff2 |  |  |  |  |  |  |  |  |  |
|  | 1 |  | toff1 |  |  |  |  |  |  |  |  |  |
| 0 | 0 |  | toff0 |  |  |  |  |  |  |  |  |  |
