...
|  |  |  |  |  |  |  |  |  |  |  |  |  | See separate table! |  |  |  |  |
| RW |  |  | 0x39 |  |  | 32 |  |  | X ENC _ |  |  | Actual encoder position (signed) |  |  | -2^31… +(2^31)-1 |  |  |
| W |  |  | 0x3A |  |  | 32 |  |  | ENC CONST _ |  |  | Accumulation constant (signed) 16 bit integer part, 16 bit fractional part X ENC accumulates _ +/- ENC CONST / (2^16*X ENC) (binary) _ _ or +/-ENC CONST / (10^4*X ENC) (decimal) _ _ ENCMODE bit enc sel decimal switches _ _ between decimal and binary setting. Use the sign, to match rotation direction! |  |  | binary: ± [µsteps/2^16] ±(0 … 32767.999847) decimal: ±(0.0 … 32767.9999) reset default = 1.0 (=65536) |  |  |
| R+ WC |  |  | 0x3B |  |  | 2 |  |  | ENC STATUS _ |  |  | Encoder status information bit 0: n event _ bit 1: deviation warn _ 1: Event detected. To clear the status bit, write with a 1 bit at the corresponding position. Deviation warn cannot be cleared while a _ warning still persists. Set ENC DEVIATION _ zero to disable. Both bits are ORed to the interrupt output signal. |  |  |  |  |  |
| R |  |  | 0x3C |  |  | 32 |  |  | ENC LATCH _ |  |  | Encoder position X ENC latched on N event _ |  |  |  |  |  |
| W |  |  | 0x3D |  |  | 20 |  |  | ENC _ DEVIATION |  |  | Maximum number of steps deviation between encoder counter and XACTUAL for deviation warning Result in flag ENC STATUS.deviation warn _ _ 0=Function is off. |  |  |  |  |  |
