...
| microstep operation s a fe ty m a rg in | dcStep operation - no step loss can occur additional flywheel mass torque reserve m a x m . o to to r rq u e |  | VMAX |
|---|---|---|---|
|  | dcStep extended application area |  |  |
| VDCMIN | Classic operation area with safety margin |  |  |
