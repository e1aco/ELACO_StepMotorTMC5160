...
Hint 
In safety critical applications, VS and the bridge may be supplied by a separate, switched supply in 
order to realize safe torque off. Make sure that the slope at VS does not exceed 1V/µs.  


<!-- detected tables -->

|  | 12VOUT 2.2µ 5VOUT 2.2µ 2R2 VCC |  | 11.5V Voltage reference switch charge pump HS regulator processing 5V Voltage regulator HS TMC5160 LS LS SPI interface Controller Chopper DIAG / INT out and B.Dwersteg, © Single wire TRINAMIC 2014 interface HS HS LS LS Encoder unit mode selection A B N | HB2 CB CB1 CB |  |  |
|---|---|---|---|---|---|---|
|  |  | 5VOUT 2.2µ 2R2 VCC |  | HB1 BMB1RG |  |  |
|  |  |  |  | BMB2 LB1 |  |  |
|  |  |  |  | CA1 HA1 CB BMA1RG |  |  |
|  |  |  |  | BMA2 LA1 |  |  |
|  |  |  |  | RG LA2 |  | RG |
