# TMC5160A_Datasheet_Rev1.14 — 第18章 SINE-WAVE LOOK-UP TABLE
...
| W0: +2/+3 | W1: +1/+2 | W2: +0/+1 | W3: -1/+0 |  |  |  | 0 MSCNT |
|---|---|---|---|---|---|---|---|
|  |  |  |  | STARTSIN90 _ |  |  |  |
| 0 X1 X2 X3 255 LUT stores entries 0 to 255 |  |  |  | 256 STARTSIN _ | 512 | 768 |  |
|  |  |  |  |  |  |  |  |
